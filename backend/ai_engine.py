...
# ⚠️ إضافة "gpt-3.5-turbo" في المقدمة: تأكَّد فعلياً بفحص مباشر (Job 5، أثناء
# انقطاع شامل 100% دام أكثر من ساعتين متواصلتين لكل من gpt-4o-mini/gpt-4/gpt-4o/
# llama-3.3-70b) أن مزوّد gpt-3.5-turbo كان لا يزال يستجيب بشكل طبيعي وسريع
# (~9.7ث) في نفس اللحظة التي كانت كل النماذج الأخرى معلّقة تماماً فيها. وضعه
# أولاً يمنح أعلى فرصة نجاح سريع حتى أثناء انقطاعات مماثلة مستقبلاً.
MODEL_CHAIN = [
    "gpt-3.5-turbo",
    "gpt-4o-mini",
    "gpt-4",
